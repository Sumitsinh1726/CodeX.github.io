  ...
  Container.innerHTML = `
    <div class="row row-cols-1 row-cols-lg-2 gy-5 gx-5">
          <div class="text-body col">
            <h2 class="fw-bold">Our 10 years of achievements</h2>
            ...
            <div class="row row-cols-1 row-cols-md-2 gy-4 gx-4">
              <div class="content-item d-flex align-items-center col">
                ...
                <div class="text ms-3">
                  ...
                  <div class="Description">Downloads per Month</div>
                </div>
              </div>
              <div class="content-item d-flex align-items-center col">
                <div class="icon">
                ...
                <div class="text ms-3">
                  <div class="title fw-bold">1 Million</div>
              ...
              <div class="content-item d-flex align-items-center col">
                ...
                <div class="text ms-3">
                  <div class="title fw-bold">200+</div>
              ...
              <div class="content-item d-flex align-items-center col">
                ...
                <div class="text ms-3">
                  <div class="title fw-bold">108</div>
